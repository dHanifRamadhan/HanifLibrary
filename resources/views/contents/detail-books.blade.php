        ...
        <div class="bg-slate-400 bg-opacity-30 border-l border-black col-span-5 relative">
            <div class="absolute top-0 -left-20 h-full flex items-center">
                <div class="p-4 bg-slate-300 rounded-md border border-black shadow-2xl">
                    <img src="{{ asset('storage/' . $data->picture) }}" alt="" width="" class="w-60">
                </div>
            </div>
                        ...
                        <div
                                ...
                                <div class="px-8 py-4 bg-slate-300 border-b border-black">
                                    ...
                                    <div class="flex gap-1 text-yellow-300">
                                        ...
                                        @for ($i = 0; $i < 10 - floor($value->rating); $i++)
                                            @if ($i % 2)
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-star" width="18"
                                                    height="18" viewBox="0 0 24 24" stroke-width="1.5"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            ...
                                            @endif
                                        @endfor
                                        <span class="text-[10px] ml-2 text-black">
                                            {{ $value->rating / 2 . '.0' }}
                                        </span>
                                    </div>
                                </div>
                            @empty
                                <div class="w-full h-full flex items-center justify-center text-slate-400">
                                    Buku ini Belum memiliki komentar !!
                                </div>
                            @endforelse
                        </div>
                        @auth
    ...
    @if (Auth::check())
        <div class="absolute top-0 right-0 bottom-0 left-0 bg-slate-400 items-center justify-center bg-opacity-40 z-50 hidden"
            ...
            <div class="bg-slate-300 border border-black rounded-md relative px-16 py-6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="absolute top-4 right-4 cursor-pointer"
                    id="btn-close-modal" width="19" height="19" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M18 6l-12 12" />
                    <path d="M6 6l12 12" />
