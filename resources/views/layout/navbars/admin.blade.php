    ...
    <div class="h-full flex items-center justify-end pr-24 gap-5">
        <div class="flex">
            ...
            <button type="button" class="flex relative items-center" onclick="OffSearch()">
                <svg xmlns="http://www.w3.org/2000/svg" class="text-slate-100 border-b-2 border-slate-100 mt-[2px]"
                    width="21" height="21" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
...
<script>
    function OffSearch() {
        ...
        if (search.classList.contains('hidden')) {
            ...
            search.classList.remove('animate-shrinkAndDisappear')
        }
    }
</script>
