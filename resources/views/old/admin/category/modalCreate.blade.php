<div class="absolute bg-slate-200 top-0 left-0 right-0 bottom-0 bg-opacity-50 z-50 hidden" id="modal">
    <div class="h-full w-full flex items-center justify-center">
        <div class="border-2 border-black py-5 px-5 relative bg-slate-200">
            <form action="{{ route('category.store') }}" method="POST" class="flex flex-col gap-5 ">
                @csrf
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="category"
                        class="bg-transparent border-b border-0 border-black px-1 w-96 outline-none" placeholder="Category"
