...
@section('main')
    ...
    <div class="absolute top-[6.7rem] left-0 right-0 bottom-0 z-50 bg-slate-100 bg-opacity-40 overflow-hidden flex"
        ...
        <div
            class="w-2/6 h-screen bg-slate-300 fixed right-0 top-[6.7rem] border-l border-black px-2 py-3 animated-element animate__animated animate__slideInRight invisible">
            <div class="h-full overflow-y-scroll flex flex-col gap-2 pb-10">
                ...
                <div class="h-max flex flex-col items-center justify-center gap-5 mb-28">
                    <div class="py-24 h-max scale-110 flex items-center">
                        <div class="h-max w-max flex items-center justify-center pt-4 scale-150">
                            <div class="relative w-44 h-60 flex pb-8">
                                <div class="w-5 rounded-tl-xl" style="background-color: {{ $detail->cover_right_color }};" id="cover_right_color">
                                </div>
                                <div class="w-[8.75rem] rounded-tr-xl flex items-start justify-end pb-2"
                                    style="background-color: {{ $detail->cover_color }};" id="cover_color">
                                ...
                                <div class="absolute bottom-5 right-[0.95rem] left-0 rounded-lg h-6"
                                    style="background-color: {{ $detail->cover_bottom_color }};" id="cover_bottom_color">
                    ...
                    <div class="relative -top-9 font-mono flex flex-col gap-5">
                        ...
                        <div class="flex gap-3 scale-75 justify-center">
                            <div class="flex gap-1 text-yellow-400 hover:text-yellow-300">
                                ...
                                @endif
                                @for ($i = 0; $i < 10 - floor($detail->rating); $i++)
                                    @if ($i % 2)
                                        <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex">
                            <div class="flex flex-col items-center px-6 py-2 border-r border-slate-800">
                                <span>
                                    {{ $detail->qty }}
                                </span>
