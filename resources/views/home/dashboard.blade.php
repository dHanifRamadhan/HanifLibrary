    <div class="mx-5 mt-4 px-8 pt-5 bg-slate-100 bg-opacity-80 rounded-md">
        ...
        <div class="mt-3 flex gap-5 overflow-x-auto w-full">
            {{-- @foreach ($data as $key) --}}
                <a href="" class="px-2w w-max" id="RecommededBooks">
    ...
    <div class="bg-slate-100 bg-opacity-80 mt-8 rounded-md mx-5 py-4 px-8">
        ...
        <div class="flex flex-row items-center py-1 pt-2 gap-2">
            @if (Route::is('dashboard'))
                <span class="px-4 py-1 text-xs border-2 border-slate-800 rounded-md bg-slate-400 text-slate-100">
                    All
                </span>
            @else
                <a href="" class="px-4 py-1 text-xs border-2 border-slate-800 rounded-md">
                    All
                </a>
            @endif
            {{-- @foreach ($data as $key => $value) --}}
                <a href=""
                    class="px-4 py-1 text-xs border-2 border-slate-800 rounded-md hover:bg-slate-400 hover:text-slate-50">
                    {{-- {{ $value->name }} --}}
                </a>
            {{-- @endforeach --}}
        </div>
        <div class="py-2 mt-3 flex flex-wrap w-full">
            <a href="" class="px-2w w-max scale-90 group hover:mx-4">
                <div class="h-max w-max flex items-center justify-center pt-4">
